...
/** Mirrors public.pricing_plans (Doka migration 0015). Public read, anon key. */
export interface PricingPlan {
  ...
  features: string[]; limits: Record<string, number | null>; highlight: boolean; sort_order: number;
}
